...
![Paquetes instalados en el capítulo 2 del Módulo](imagenes/imagen_resumen.png)
...
<img src="imagenes/imagen_resumen.png" width="200" height="140">

<br>

- Imagen centrada con tamaño definido y caption:
<p align="right">
<img src="imagenes/imagen_resumen.png" title="Paquetes instalados en el capítulo 2 del Módulo" width="200" height="140">
...
profesores <- read_excel("Datos_R/r_profesores.xlsx")
...
Se hace un gráfico con el paquete "Datos":
...
El mismo gráfico pero solo el código:

```{r trans5, echo=TRUE, eval=FALSE}
diamantes %>% ggplot(aes(x = corte, 
                         fill=corte)) +
    geom_bar(alpha=0.8) +
    scale_fill_brewer(palette = "Dark2") +
